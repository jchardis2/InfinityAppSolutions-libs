...
public class DBUtil {
	...
	/**
	 * Returns the last ID that was generated for an auto-increment column.
	 * Please note that this does NOT cause transaction problems!
	 * last_insert_id() returns the last generated ID on a per-connection basis.
