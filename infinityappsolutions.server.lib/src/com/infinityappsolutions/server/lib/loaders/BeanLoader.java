 ...
 * loader.
 * 
 * The generic type <T> specifies the type of bean that the loader is
 * responsible for extacting from a result set.
 * 
 * @param <T>
 *            A type for the bean that will be loaded with this class.
 */
public interface BeanLoader<T> {
	/**
	 * Loads a list of the bean of type T from a result set. Typically makes
	 * iterated calls to loadSingle.
	 * 
	 * @param rs
	...
	/**
	 * Contains the instructions for mapping the rows in this java.sql.ResultSet
	 * into beans of type <T>.
	 * 
	 * @param rs
	 *            The java.sql.ResultSet to be loaded.
	 * @return A Bean of type T containing the loaded information, typically of
	 *         the first (or next) item in the result set.
	 * @throws SQLException
	 */
	 ...
	 * @throws SQLException
	 */
	public T loadSingle(ResultSet rs, T b) throws SQLException;
